...
public class GroupInvitationController {
  ...
  public ResponseEntity<Object> sendInvitation(
      @RequestBody Map<String, Object> groupInvitationBody) {
    return groupInvitationService.sendGroupInvitation(groupInvitationBody);
  }

  @PostMapping("/accept-invitation")
  public ResponseEntity<Object> acceptInvitation(
      @RequestBody Map<String, String> groupInvitationBody) {
    return groupInvitationService.acceptGroupInvitation(
        groupInvitationBody.get("group_invitation_id"));
  }

  @PostMapping("/reject-invitation")
  public ResponseEntity<Object> rejectInvitation(
      @RequestBody Map<String, String> groupInvitationBody) {
    return groupInvitationService.declineGroupInvitation(
        groupInvitationBody.get("group_invitation_id"));
  }
